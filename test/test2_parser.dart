class Test2Parser {
      ...
      while (true) {
        switch ($2) {
          ...
          case 3:
            ...
            if (state.pos < $7.end) {
              final ok = $7.data.codeUnitAt(state.pos - $7.start) == 43;
              if (ok) {
                state.advance(1);
                state.setOk(true);
              } else {
      ...
      while (true) {
        switch ($2) {
          ...
          case 2:
            ...
            state.input.endBuffering();
            final $19 = !state.ok && state.isRecoverable;
            if (!$19) {
              $2 = 9;
              break;
            }
          ...
          case 4:
            ...
            if (state.pos < $7.end) {
              final ok = $7.data.codeUnitAt(state.pos - $7.start) == 97;
              if (ok) {
                state.advance(1);
                state.setOk(true);
              } else {
          ...
          case 6:
            ...
            if (state.pos < $9.end) {
              final ok = $9.data.codeUnitAt(state.pos - $9.start) == 98;
              if (ok) {
                state.advance(1);
                state.setOk(true);
              } else {
          ...
          case 10:
            ...
            if (state.pos < $13.end) {
              final ok = $13.data.codeUnitAt(state.pos - $13.start) == 48;
              if (ok) {
                state.advance(1);
                state.setOk(true);
              } else {
      ...
      while (true) {
        switch ($2) {
          ...
          case 2:
            ...
            if (state.pos < $10.end) {
              final c = $10.data.codeUnitAt(state.pos - $10.start);
              final $11 = c >= 48 && c <= 57;
              if ($11) {
                state.advance(1);
                state.setOk(true);
      ...
      while (true) {
        switch ($2) {
          ...
          case 4:
            ...
            if (state.pos < $6.end) {
              final ok = $6.data.codeUnitAt(state.pos - $6.start) == 44;
              if (ok) {
                state.advance(1);
                state.setOk(true);
              } else {
  ...
  void fastParseOneOrMoreLiteral(State<String> state) {
    ...
    while (true) {
      const $4 = 'abc';
      final $5 = state.pos + 2 < state.input.length &&
          state.input.codeUnitAt(state.pos) == 97 &&
          state.input.codeUnitAt(state.pos + 1) == 98 &&
          state.input.codeUnitAt(state.pos + 2) == 99;
      if ($5) {
      ...
      while (true) {
        switch ($2) {
          ...
          case 4:
            ...
            if (state.pos < $8.end) {
              final ok = $8.data.codeUnitAt(state.pos - $8.start) == 92;
              if (ok) {
                state.advance(1);
                state.setOk(true);
              } else {
          ...
          case 5:
            ...
            if (state.pos < $10.end) {
              final ok = $10.data.codeUnitAt(state.pos - $10.start) == 116;
              if (ok) {
                state.advance(1);
                state.setOk(true);
              } else {
      ...
      while (true) {
        switch ($2) {
          ...
          case 8:
            ...
            if (state.pos < $17.end) {
              final c = $17.data.codeUnitAt(state.pos - $17.start);
              final $18 = c >= 48 && c <= 49;
              if ($18) {
                state.advance(1);
                $14 = c;
      ...
      while (true) {
        switch ($3) {
          ...
          case 3:
            ...
            if (state.pos < $12.end) {
              final ok = $12.data.codeUnitAt(state.pos - $12.start) == 43;
              if (ok) {
                state.advance(1);
                state.setOk(true);
                $5 = 43;
      ...
      while (true) {
        switch ($3) {
          ...
          case 1:
            ...
            final $12 = !state.ok && state.isRecoverable;
            if (!$12) {
              $3 = 2;
              break;
            }
      ...
      while (true) {
        switch ($3) {
          ...
          case 4:
            ...
            if (state.pos < $12.end) {
              final ok = $12.data.codeUnitAt(state.pos - $12.start) == 97;
              if (ok) {
                state.advance(1);
                state.setOk(true);
                $6 = 97;
          ...
          case 6:
            ...
            if (state.pos < $14.end) {
              final ok = $14.data.codeUnitAt(state.pos - $14.start) == 98;
              if (ok) {
                state.advance(1);
                state.setOk(true);
                $6 = 98;
      ...
      while (true) {
        switch ($3) {
          ...
          case 2:
            ...
            if (state.pos < $11.end) {
              final c = $11.data.codeUnitAt(state.pos - $11.start);
              final $12 = c >= 48 && c <= 57;
              if ($12) {
                state.advance(1);
                $8 = c;
      ...
      while (true) {
        switch ($3) {
          ...
          case 5:
            ...
            if (state.pos < $11.end) {
              final ok = $11.data.codeUnitAt(state.pos - $11.start) == 44;
              if (ok) {
                state.advance(1);
                state.setOk(true);
              } else {
  ...
  List<String>? parseOneOrMoreLiteral(State<String> state) {
    ...
    while (true) {
      String? $5;
      const $6 = 'abc';
      final $7 = state.pos + 2 < state.input.length &&
          state.input.codeUnitAt(state.pos) == 97 &&
          state.input.codeUnitAt(state.pos + 1) == 98 &&
          state.input.codeUnitAt(state.pos + 2) == 99;
      if ($7) {
        ...
        switch ($3) {
          ...
          case 2:
            ...
            final $8 = state.pos + 2 < $6.end &&
                $6.data.codeUnitAt(state.pos - $6.start) == 97 &&
                $6.data.codeUnitAt(state.pos - $6.start + 1) == 98 &&
                $6.data.codeUnitAt(state.pos - $6.start + 2) == 99;
            if ($8) {
              state.advance(3);
              state.setOk(true);
              $4 = $7;
  ...
  AsyncResult<Object?> parseStart$Async(State<ChunkedParsingSink> state) {
    ...
    late int $281;
    Object? $280;
    late AsyncResult<Object?> $282;
    late AsyncResult<Object?> $284;
    late int $287;
    List<int>? $286;
    late AsyncResult<List<int>> $288;
      ...
      while (true) {
        switch ($3) {
          ...
          case 2:
            ...
            final $293 = !state.ok && state.isRecoverable;
            if (!$293) {
              $3 = 4;
              break;
            }
          ...
          case 6:
            ...
            final $295 = !state.ok && state.isRecoverable;
            if (!$295) {
              $3 = 8;
              break;
            }
          ...
          case 10:
            ...
            final $297 = !state.ok && state.isRecoverable;
            if (!$297) {
              $3 = 12;
              break;
            }
          ...
          case 185:
            ...
            $284 = fastParseVerify$Async(state);
            if (!$284.isComplete) {
              $284.onComplete = $1;
              $3 = 187;
              return;
      ...
      while (true) {
        switch ($3) {
          ...
          case 5:
            ...
            if (state.pos < $14.end) {
              final ok = $14.data.codeUnitAt(state.pos - $14.start) == 92;
              if (ok) {
                state.advance(1);
                state.setOk(true);
              } else {
          ...
          case 6:
            ...
            if (state.pos < $16.end) {
              final ok = $16.data.codeUnitAt(state.pos - $16.start) == 116;
              if (ok) {
                state.advance(1);
                state.setOk(true);
              } else {
      ...
      while (true) {
        switch ($3) {
          ...
          case 8:
            ...
            if (state.pos < $20.end) {
              final c = $20.data.codeUnitAt(state.pos - $20.start);
              final $21 = c >= 48 && c <= 49;
              if ($21) {
                state.advance(1);
                $2 = c;
