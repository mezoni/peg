...
- `@errorHandler`
- `@verify` (не реализован на данный момент)
...
**Предупреждение:**
Не реализован на данный момент.
...
Данное мета-выражение позволяет достаточно решать задачи контекстно-зависимых грамматик.  
